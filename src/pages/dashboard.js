    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsxs("nav", {
            className:
              "bg-card border-b border-border h-16 flex items-center justify-between px-6 shadow-sm",
            children: [
              _jsx("div", {
                ...
                children: _jsxs("div", {
                  ...
                  children: [
                    _jsx("div", {
                      className:
                        "w-8 h-8 bg-accent rounded-md flex items-center justify-center",
                    ...
                    _jsx("h1", {
                      ...
                      children: "Drill AI Intelligence Platform",
                    }),
                  ],
                }),
              }),
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx(Button, {
                    variant: "ghost",
                    size: "icon",
                    children: _jsx(Bell, { className: "h-5 w-5" }),
                  }),
                  _jsx(Button, {
                    variant: "ghost",
                    size: "icon",
                    children: _jsx(User, { className: "h-5 w-5" }),
                  }),
                ],
              }),
            ],
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx(RockCompositionChart, { data: wellData }),
                      _jsx(WellDataChart, {
                        data: wellData,
                        title: "DT",
                        dataKey: "dt",
                  ...
                  _jsx(DataTable, { data: wellData }),
                  isMobile &&
                    _jsx("div", {
                      className: "mt-6",
                      children: _jsx(AiChat, {
                        wellName: selectedWell?.name || "Unknown Well",
                      }),
                    }),
                ],
              }),
      ...
      !isMobile &&
        _jsx("div", {
          className:
            "w-96 border-l border-border bg-card sticky top-0 h-screen",
          children: _jsx("div", {
